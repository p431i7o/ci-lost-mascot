        ...
        if(count($reportes)>0){
            foreach($reportes as $fila){
                ...
                foreach($fila->imagenes_reporte as $imagen){
                    echo "<img width='100' style='margin-left:10px;' class='img-thumbnail' src='".base_url('reporte/getImagen/'.$imagen->imagen_miniatura)."/thumb'/>";
                }
            ...
            echo "<h3>Sin reportes de momento</h3>";
        }
